...
<div class="kont">
    <form action="/Project_F_OPH/AdminCreatePorudzba" method="post">
		...
		<select class="form-control" id="exampleFormControlSelect1" name="korisnici_tabela">
    ...
    <label for="exampleFormControlSelect1">Izaberite dostavljača: </label>
		<select class="form-control" id="exampleFormControlSelect1" name="dostavljaci_tabela">
    ...
    <label for="exampleFormControlSelect1">Unesite količinu: </label>
		<input class="form-control" id="exampleFormControlInput1" type="text" name="kolicina">
	</div>
