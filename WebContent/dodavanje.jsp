...
<div class="kont">
    <form action="/Project_F_OPH/AdminRestoran">
        <div class="form-group">
            <input type="button" id="myBtn" class="form-control" required>
        </div>
        <div class="form-group">
            <input type="text" name="naziv_restorana" class="form-control" placeholder="Naziv restorana" required>
        </div>
        <div class="form-group">
            <input type="text" name="adresa_restorana" class="form-control" placeholder="Adresa restorana" required>
        </div>
        <div class="form-group">
            <select class="form-control" name="kategorija_restorana">
