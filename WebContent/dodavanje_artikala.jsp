...
<div class="kont">
    <form action="/Project_F_OPH/AdminCreate">
        <div class="form-group">
            <input type="text" name="naziv_artikla" class="form-control" placeholder="Naziv artikla" required>
        </div>
        <div class="form-group">
            <input type="text" name="cjena_artikla" class="form-control" placeholder="Cjena artikla" required>
        </div>
        <div class="form-group">
            <input type="text" name="kolicina_grami_mililitri" class="form-control" placeholder="Količina porcije artikla" required>
        </div>
        <div class="form-group">
            <input type="text"  name="kolicina_artikla" class="form-control" placeholder="Na stanju" required>
        </div>
        <div class="form-group">
            <select class="form-control" name = "restoran_artikal" placeholder="Restoran" required>
            <c:forEach var="restoran" items="${restorani}">
				<option><c:out value="${restoran.getRestoran_naziv()}" /></option>
			</c:forEach>
                    </select>
        </div>
        <div class="form-group">
            <select class="form-control" placeholder="Tip" name="tip_artikla" required>
            <option value="jelo">Jelo</option>
            <option value="pice">Piće</option>
                    </select>
        </div>
        <div class="form-group">
            <input style="height: 100px;" name="opis_artikla" type="text" class="form-control" placeholder="Opis artikla" required>
        </div>
