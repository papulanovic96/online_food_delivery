...
<div class="kont">
    <form action="/Project_F_OPH/AdminCreate">
        <div class="form-group">
            <input type="text" name="marka_vozila" class="form-control" placeholder="Marka vozila" value="<%=request.getAttribute("mar")%>" required>
        </div>
        <div class="form-group">
            <input type="text" name="model_vozila" class="form-control" placeholder="Model vozila" value="<%=request.getAttribute("mod")%>" required>
        </div>
        <div class="form-group">
            <input type="text" name="registracija_vozila" class="form-control" placeholder="Registarska oznaka vozila" value="<%=request.getAttribute("reg")%>" required>
        </div>
        <div class="form-group">
            <input type="text" name="godiste_vozila" class="form-control" placeholder="Godina proizvodnje vozila" value="<%=request.getAttribute("god")%>" required>
        </div>
        <div class="form-group">
            <input type="text" name="napomena_vozila" class="form-control" placeholder="Napomena" value="<%=request.getAttribute("nap")%>" required>
        </div>
        ...
        <div class="form-group">
            <select class="form-control" name="tip_vozila" id="mySelect">
