...
<table class="table table-hover" id="myTable">
	...
	<c:forEach var="admin" items="${admini}">
	<tr>
...
<table class="table table-hover" id="myTable">
	...
	<tr>
		...
		<td><c:out value="${admin.getEmail()}" /></td>
		<td><c:out value="${admin.getRegistration_date()}" /></td>
		<c:if test="${!admin.getUser_name().equals('mladen')}">
		<td><a class="btn btn-warning" href="/Project_F_OPH/AdminTypeChange?izmjeni_tip_admin=${admin.getUser_name()}">Izmjeni</a></td>
		</c:if>
		</tr>
	</c:forEach>
