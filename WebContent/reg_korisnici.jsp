...
<table class="table table-hover" id="myTable">
	<tr>
		...
		<th>Lista porudžbina</th>
		<th>Lista omiljenih restorana</th>
		<th></th>
	</tr>
	<c:forEach var="korisnik" items="${korisnici}">
	<tr>
		<td><c:out value="${korisnik.getName()}" /></td>
		<td><c:out value="${korisnik.getLastname()}" /></td>
		<td><c:out value="${korisnik.getUser_name()}" /></td>
		<td><c:out value="${korisnik.getUser_password()}" /></td>
		<td><c:out value="${korisnik.getUser_type()}" /></td>
		<td><c:out value="${korisnik.getContact_phone()}" /></td>
		<td><c:out value="${korisnik.getEmail()}" /></td>
		<td><c:out value="${korisnik.getRegistration_date()}" /></td>
		<td><c:out value="${korisnik.getPorString()}" /></td>
		<td><c:out value="${korisnik.getOmiljeniString()}" /></td>
	</tr>
	</c:forEach>
...
<table class="table table-hover" id="myTable">
	...
	<tr>
		...
		<td><c:out value="${korisnik.getPorString()}" /></td>
		<td><c:out value="${korisnik.getOmiljeniString()}" /></td>
		<td><a class="btn btn-warning" href="/Project_F_OPH/AdminTypeChange?izmjeni_tip=${korisnik.getUser_name()}">Izmjeni</a></td>
		</tr>
	</c:forEach>
