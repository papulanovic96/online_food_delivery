...
<c:forEach var="entry" items="${top_10}">

								<div class="col-md-4 top_brand_left" style="margin-top: 20px">
									<div class="hover14 column">
										<div class="agile_top_brand_left_grid">
											<div class="agile_top_brand_left_grid_pos">
												<img src="img/artikal.png" alt="IMG-LOGO" data-logofixed="imglogo2.png">
											</div>
												...
												<figure>
													<div class="snipcart-item block" >
														<div class="snipcart-thumb">
															<a href="index.jsp">
																	<img src="img/logo-invert.png" alt="IMG-LOGO" data-logofixed="imglogo2.png"></a>		
															<p><c:out value="${entry.value} KM" /></p>
															<div class="stars">
															...
															<h4><c:out value="${entry.key.getArtikal_kolicina_vr()}" /></h4>
														</div>
														<div class="snipcart-details top_brand_home_details">
															<form action="#" method="post">
																<fieldset>
																	<input type="submit" name="submit" value="<c:out value="${entry.key.getNaziv_artikla()}" />" class="button" />
																</fieldset>
															</form>
														</div>
													</div>
