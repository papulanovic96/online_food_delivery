...
<table class="table table-hover" id="myTable">
	...
	<c:forEach var="vozilo" items="${vozila}">
	<tr>
		<td><c:out value="${vozilo.getMarka_vozila()}" /></td>
		<td><c:out value="${vozilo.getModel_vozila()}" /></td>
		<td><c:out value="${vozilo.getTip_vozila()}" /></td>
		<td><c:out value="${vozilo.getRegistracija_vozila()}" /></td>
		<td><c:out value="${vozilo.getGod_proizvodnje_vozila()}" /></td>
		<td><c:out value="${vozilo.isUpotreba_vozila()}" /></td>
		<td><c:out value="${vozilo.getNapomena()}" /></td>
	</tr>
	</c:forEach>
...
<table class="table table-hover" id="myTable">
	...
	<tr>
		...
		<td><c:out value="${vozilo.isUpotreba_vozila()}" /></td>
		<td><c:out value="${vozilo.getNapomena()}" /></td>
		<td><a class="btn btn-warning" href="/Project_F_OPH/AdminEdit?izmjeni_vozilo=${vozilo.getModel_vozila()}">Izmjeni</a></td>
		<td><a class="btn btn-danger" href="/Project_F_OPH/AdminDelete?obrisi=${vozilo.getModel_vozila()}">Obriši</a></td>
	</tr>
	</c:forEach>

</table>
<br>
<a href="dodavanje_vozila.jsp" class="btn btn-success">+ Novo vozilo</a>
</div></div></div>
</c:if>
