...
<table class="table table-hover" id="myTable">
	...
	<c:forEach var="vozilo" items="${vozila}">
	<tr>
	<c:if test="${vozilo.isUpotreba_vozila().equals('Slobodno')}">
		<td><c:out value="${vozilo.getMarka_vozila()}" /></td>
		<td><c:out value="${vozilo.getModel_vozila()}" /></td>
		<td><c:out value="${vozilo.getTip_vozila()}" /></td>
		<td><c:out value="${vozilo.getRegistracija_vozila()}" /></td>
		...
		<td><c:out value="${vozilo.isUpotreba_vozila()}" /></td>
		<td><c:out value="${vozilo.getNapomena()}" /></td>
		<td><a class="btn btn-warning" href="/Project_F_OPH/DostavaVozilo?zauzmi_vozilo=${vozilo.getModel_vozila()}"> Zauzmi</a></td>
	</c:if>
	</tr>
	</c:forEach>
